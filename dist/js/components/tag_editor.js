...
var TagEditor = _react2.default.createClass({
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      ...
      this.state.showMenu ? _react2.default.createElement('div', { className: 'layer__click-off', onClick: function onClick(event) {
          return _this2.onClickOff(event);
        } }) : null
    );
  }
});
